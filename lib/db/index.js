const usersTable = require('./db_sql/account');
const notesTable = require('./db_sql/notes');
const tagsTable = require('./db_sql/tags');
const cvTable = require('./db_sql/cv');
...
createTable(notesTable)
createTable(tagsTable)
createTable(cvTable)
// createTable(posts)
// createTable(comment)
